...
public class MovieRecommendationEngine {
	...
	public static void main(String[] args) {
		...
		JavaRDD<String> userItemRatingsFile = sc.textFile("C:/Work/Projects/SparkStreamingExamples/data/rating.csv");
		
		// Read item description file. format - itemId, itemName, Other Fields,..
		JavaRDD<String> itemDescritpionFile = sc.textFile("C:/Work/Projects/SparkStreamingExamples/data/movie.csv");
		...
		int numIterations = Integer.parseInt("5"); // number of iterations
